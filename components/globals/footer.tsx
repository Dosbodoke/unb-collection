      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="space-y-4">
          ...
          <p className="text-gray-400">
            UNB Collection é um projeto que introduz o estilo Streetwear nos
          ...
          <div className="flex flex-col gap-4">
            <div className="space-y-2">
              <p className="text-gray-400">
                ...
                novidades de coleções e muito mais!
              </p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-gray-400 dark:text-gray-400">
              Sua segurança é nossa prioridade. Todas as suas informações são
              protegidas com criptografia SSL, garantindo uma navegação segura
              em nosso site.
            </p>
          </div>
        </div>
